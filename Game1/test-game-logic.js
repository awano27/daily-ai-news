...
const juniorHighMathSamples = [
  ...
  [star, 0, "multiStepEquation", "number"],
  [star, 0.1, "factorization", "string"],
  [star, 0.2, "quadratic", "number"],
  [star, 0.3, "quadraticFormula", "string"],
  [star, 0.4, "quadraticFunction", "number"],
  [star, 0.5, "similarityArea", "number"],
  [star, 0.6, "pythagorean3d", "number"],
  [star, 0.7, "squareRootSimplify", "string"],
  [star, 0.8, "functionValue", "number"],
  [star, 0.9, "probability", "string"],
];
